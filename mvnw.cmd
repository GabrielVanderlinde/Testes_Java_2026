...
:error
if "%OS%" == "Windows_NT" set ERROR_CODE=1
exit /b %ERROR_CODE%

:valM2

REM Strip all trailing "s from M2_HOME
if not [%M2_HOME%]==[] (
  if "%M2_HOME:~-1%"=="\" set "M2_HOME=%M2_HOME:~0,-1%"
)
...
REM Extend MAVEN_OPTS with JVM_CONFIG_MAVEN_PROPS
