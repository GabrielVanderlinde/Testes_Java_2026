...
```
Testes_Java_2026/
├── docs/                    # Documentação geral do curso
│   ├── README.md           # Plano de ensino completo
│   └── index.html          # Versão HTML do plano de ensino
├── aulas/                   # Conteúdo de cada aula
...
│   ├── aula-13/            # Testes de Repositório
│   ├── aula-14/            # Testes de Controller
│   └── aula-15/            # Projeto Integrador
├── recursos/                # Recursos compartilhados (templates, etc.)
└── .gitignore              # Arquivos ignorados pelo Git
```

**Cada pasta de aula contém:**
- `aula-XX.md` - Roteiro completo da aula em Markdown
- `aXX_exposicao.html` - Material de exposição teórica
- `aXX_demo_ao_vivo.html` - Demonstrações práticas ao vivo
- `aXX_pratica_guiada.html` - Prática guiada passo a passo
- `aXX_desafio.html` - Desafios para fixação
- `aXX_feedback.html` - Feedback e gabaritos
